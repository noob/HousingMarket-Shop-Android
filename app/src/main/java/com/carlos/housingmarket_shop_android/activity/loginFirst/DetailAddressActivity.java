...
public class DetailAddressActivity extends AppCompatActivity implements LocationSource, AMapLocationListener{
    ...
    private final static String TAG = "DetailAddressActivity";
    //定位需要的声明
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = DetailAddressActivity.this;
        ...
        if (amapLocation != null) {
            if (amapLocation.getErrorCode() == 0) {
                ...
                if (isFirstLoc) {
                    ...
                    //添加图钉
                    final Marker marker = aMap.addMarker(getMarkerOptions(amapLocation));
